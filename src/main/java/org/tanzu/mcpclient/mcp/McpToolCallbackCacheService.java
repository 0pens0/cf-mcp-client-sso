...
/**
 * Caches MCP tool callback providers with event-driven invalidation.
 * Listens for McpToolsChangedEvent to refresh the cache when tools change,
 * avoiding repeated tool discovery on every chat request.
 */
@Service
