...
/**
 * Encapsulates a single MCP server connection with protocol support.
...
public class McpServerService {
    ...
    public McpServerService(String name, String serverUrl, ProtocolType protocol,
                            Map<String, String> headers, McpClientFactory clientFactory) {
        this.name = name;
