...
/**
 * Service that collects and provides platform metrics including models, MCP servers, prompts, and A2A agents.
 * Listens to various configuration events and maintains current state for monitoring and status display.
 */
@Service
public class MetricsService {
    ...
    public void handleChatConfigurationEvent(ChatConfigurationEvent event) {
        ...
        this.mcpServersWithHealth = event.getMcpServersWithHealth() != null
                ? event.getMcpServersWithHealth() : List.of();
